...
const AnalyzePage: React.FC<AnalyzePageProps> = ({ result, onNavigate, onUpdateScanResult }) => {
  ...
  const sharedCardPadding = activeTab === 'llm'
    ? 'clamp(26px, 4.2vh, 40px)'
    : 'clamp(20px, 3vh, 30px)';
  const llmBodyFontSize = '13px';
  const llmBodyLineHeight = '1.5';
  const llmTitleFontSize = '18px';
  const llmButtonPadding = '10px 18px';
  const llmButtonHeight = '42px';
  const llmButtonFontSize = '13px';
  const llmNoteFontSize = '12px';
  const llmNoteMarginTop = '6px';
  const llmContentGap = '12px';
        ...
        return (
          <div style={{
            ...
            <div style={{
              ...
              <FaFileContract size={24} color="#FFFFFF" />
              <h2 style={{
            ...
            <p style={{
              ...
              This is a report on the results of using the CryptoScanner app to find Non-PQC in FILEs/FOLDERs.
              <br />
              * These results were generated by an LLM. Use them for reference only.
            </p>
  ...
  return (
    <>
      ...
      {/* Tab Content */}
      {activeTab === 'overview' || (activeTab === 'llm' && result.type !== 'FULL_SCAN') ? (
            ...
            {activeTab === 'overview' ? (
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <FaFileContract size={20} color="#FFFFFF" />
                  <h2 style={{
                    fontFamily: 'SF Pro Rounded',
                    fontWeight: 600,
                    fontSize: llmTitleFontSize,
                    color: '#FFFFFF',
                    margin: 0
                  }}>Report</h2>
                </div>
                ...
                <p style={{
                  fontFamily: 'SF Pro',
                  fontSize: llmBodyFontSize,
                  color: 'rgba(255, 255, 255, 0.8)',
                  textAlign: 'center',
                  margin: 0,
                  lineHeight: llmBodyLineHeight,
                  padding: '0 10px',
                  maxWidth: '90%',
                  wordWrap: 'break-word',
                  ...
                  <span style={{
                    ...
                    fontSize: llmNoteFontSize,
                    marginTop: llmNoteMarginTop
                  }}>
                    * These results were generated by an LLM.
                    <br />
                ...
                <button
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: '8px',
                    padding: llmButtonPadding,
                    height: llmButtonHeight,
                    minHeight: llmButtonHeight,
                    background: isGeneratingReport
                      ? 'rgba(128, 128, 128, 0.5)'
                      : 'linear-gradient(0deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), rgba(255, 255, 255, 0.5)',
                    backgroundBlendMode: 'normal, overlay',
            ...
            {activeTab === 'overview' ? (
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  This is an LLM scan for a single file.
                  <br />
                  Supports DISASSEMBLY FILEs, SOURCE CODE FILEs, etc.
                  <br />
                  <span style={{
                    display: 'inline-block',
                    fontSize: llmNoteFontSize,
                    ...
                    * Results are responses from the LLM.
                    <br />
